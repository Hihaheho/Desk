...
fn is_subtype_of_returns_false_if_input_is_not_supertype() {
    ...
    .is_subtype_of(&Arrow::new(Type::Number, Type::String)));
}

#[test]
fn is_subtype_of_returns_true_if_input_is_supertype() {
    assert!(
        Arrow::new(Type::sum(vec![Type::Number, Type::String]), Type::String)
            .is_subtype_of(&Arrow::new(Type::Number, Type::String))
    );
}
...
fn is_subtype_of_returns_false_if_output_is_not_subtype() {
    assert!(
        !Arrow::new(Type::Number, Type::sum(vec![Type::Number, Type::String]))
            .is_subtype_of(&Arrow::new(Type::Number, Type::String))
    );
}
